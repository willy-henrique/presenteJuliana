  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 p-4 relative overflow-hidden">
      ...
      <div className="absolute top-4 right-4 z-20">
        ...
        >
          {isPlaying ? <MusicOff className="h-5 w-5 text-pink-600" /> : <Music className="h-5 w-5 text-pink-600" />}
        </Button>
      </div>
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-white/30 relative">
          <h1 className="text-3xl font-bold text-center mb-4 font-dancing text-pink-600">
            Capitulo 5 - O xeque-mate no bebedouro
          </h1>

          <div className="relative w-full h-64 mb-6 overflow-hidden rounded-xl shadow-lg border-2 border-pink-100">
            <Image src="/images/bebedouro.jpg" alt="Nosso momento" fill className="object-cover" priority />

            {!showKiss ? (
              <div className="absolute inset-0 flex items-center justify-center bg-black/50">
                <p className="text-white text-xl font-dancing text-center px-6">Eai meu amor, vai ficar me enrolando ate quando?</p>
              </div>
            ) : (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-pink-100/50 to-purple-100/50">
                ...
                />
                <p className="text-pink-600 font-dancing text-lg mt-4">Nosso primeiro beijo!</p>
              </div>
            )}
          </div>
          ...
          {showDate ? (
            <div className="text-center mb-6">
              ...
              <p className="text-pink-600 mt-3 font-dancing">O dia em que nossos coracoes se encontraram</p>
            </div>
          ) : showKiss ? (
            ...
            <div className="space-y-6">
              ...
              {enrolarAttempts > 0 && (
                <div className="text-center">
                  <p className="text-pink-500 text-sm font-dancing">Tentativas de fugir: {enrolarAttempts}</p>
                </div>
              )}
            </div>
          )}
