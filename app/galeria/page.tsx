...
export default function LivroDeFotos() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-pink-100 to-lavender-100 p-4 relative overflow-hidden">
      ...
      <h1 className="text-3xl font-bold text-pink-600 mb-4 text-center font-dancing">
        Nosso Livro de Memórias
      </h1>

      <div className="relative w-full max-w-md aspect-video bg-white rounded-xl shadow-2xl border border-pink-200 overflow-hidden">
